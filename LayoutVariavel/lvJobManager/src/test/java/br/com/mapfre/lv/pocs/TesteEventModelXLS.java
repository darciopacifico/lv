...
public class TesteEventModelXLS implements HSSFListener {
	...
	public static void main(String[] args) throws IOException {
		...
		// at the command line
		FileInputStream fin = new FileInputStream("planilhaTeste_240k.xls");
		...
		req.addListenerForAllRecords(new TesteEventModelXLS());
	...
	public void processRecord(Record record) {
		...
		*/
		case NumberRecord.sid:
			...
			System.out.println("val:" + numrec.getValue()
		...
		case LabelSSTRecord.sid:
			...
			System.out.println("val:" + sstrec.getString(lrec.getSSTIndex()));
			break;
		}
	}
